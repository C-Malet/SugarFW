<?php
    ...
    include_once 'functions/SugarFunctions.class.php';
    include_once 'routers/SugarRouter.class.php';

    // http://stackoverflow.com/a/10298907/2627459
    $url = "http" . (($_SERVER['SERVER_PORT'] == 443) ? "s://" : "://") . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];

    include_once 'helpers/SugarGlobals.class.php';
    include_once 'helpers/SugarConfiguration.class.php';
    include_once 'helpers/SugarLogs.class.php';
